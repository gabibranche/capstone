...
//unsigned long gunshotTime[] = {51800, 69100, 112000, 275000};
//unsigned long gunshotEnd[] = {55800, 73000, 116000};

//Papa Bois Values: values needed to be calibrated taking into account that the pixels take roughly 5 secs to change
unsigned long gunshotTime[] = {39200, 51500, 79900, 150000};
unsigned long gunshotEnd[] = {43000, 55500, 83200};
...
//    Serial.println(cm);
    ...
    if (cm <= 100 && gunRing == false) {
      // pixels.Color() takes RGB values, from 0,0,0 up to 255,255,255
      // Here we're using a moderately bright green color:

      UltraRcolor = map(cm, 50, 5, 200, 255);
      UltraGcolor = map(cm, 50, 5, 50, 0);

    }

    else  if (cm > 100 && gunRing == false) {
      UltraRcolor = 0;
      UltraGcolor = 150;
      UltraBcolor = 0;
      //      ledState = LOW;
